// This file is for seeding test data when in a development environment. This is not used in the apps production build
...
const seed = async () => {
  try {
    ...
    console.log('[seed] : SUCCESSFULLY LOADED');

  } catch {
    throw new Error("WARNING!! Failed to seed database")
  }
};
